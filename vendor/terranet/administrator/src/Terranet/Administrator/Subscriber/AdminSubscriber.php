<?php namespace Terranet\Administrator\Subscriber;
...
class AdminSubscriber
{
    ...
    {
        $events->listen('admin.login', '\Terranet\Administrator\Subscriber\AdminSubscriber@onUserLogin');

        $events->listen('admin.logout', '\Terranet\Administrator\Subscriber\AdminSubscriber@onUserLogout');

        $events->listen('admin.performAction', '\Terranet\Administrator\Subscriber\AdminSubscriber@onPerformAction');
    }
