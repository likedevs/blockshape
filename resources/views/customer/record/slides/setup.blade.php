...
<md-card>    
    <md-card-content>
        ...
        <md-input-container>
            <md-radio-group ng-model="data.target_id" label-area="Scope" required layout="row">
...
<md-card>
    ...
    <div layout="row" layout-align="end center">
        ...
        <md-button class="md-primary" ng-disabled="! isStepValid('setup')" ng-click="slideNext()">{{ trans('pagination.next') }}</md-button>
    </div>  
</md-card>
