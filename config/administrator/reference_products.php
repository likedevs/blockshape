...
return [
    ...
    */
    'columns'             => [
        ...
        'proteins'      => ['sortable' => false],
        'lipids'        => ['sortable' => false],
        'disaccharides' => ['sortable' => false],
        'starch'        => ['sortable' => false],
        'energy_value'  => ['sortable' => false]
    ],
    /*
    |-------------------------------------------------------
    | Row actions
    ...
    */
    'filters'             => [
        ...
        'group_id' => [
            'type'    => 'select',
            'options' => function () {
                return ['' => '--Any--'] + ReferenceGroup::lists('name', 'id')->toArray();
            }
        ]
    ],
    /*
    ...
    */
    'edit_fields'         => [
        'group_id'      => [
            'type'    => 'select',
            'options' => function () {
                return ReferenceGroup::lists('name', 'id');
            }
        ],
        'name'          => [
            'type'         => 'text',
        ...
        'name'          => ['type' => 'text'],
        'proteins'      => ['type' => 'number', 'step' => 0.1, 'max' => 100],
        'lipids'        => ['type' => 'number', 'step' => 0.1, 'max' => 100],
        'disaccharides' => ['type' => 'number', 'step' => 0.1, 'max' => 100],
        'starch'        => ['type' => 'number', 'step' => 0.1, 'max' => 100],
        'energy_value'  => ['type' => 'number', 'step' => 1]
    ],
    /*
    |-------------------------------------------------------
