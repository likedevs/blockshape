...
return [
    ...
    */
    'edit_fields'         => [
        ...
        'type' => [
            'type'         => 'select',
            'options'      => ['fese/coapse' => 'fese/coapse', 'talie/abdomen' => 'talie/abdomen', 'general' => 'general', 'presentation' => 'prezentare'],
        ],
        'instructor_id' => [
            'type' => 'select',
            'options' => function(){
                return \App\Instructor::lists('name', 'id');
            }
        ]
    ],
    /*
